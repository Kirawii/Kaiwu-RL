...
#### create\_cls[​](#create_cls "标题的直接链接")
...
#### observation\_process[​](#observation_process "标题的直接链接")
...
#### action\_process[​](#action_process "标题的直接链接")
...
### reward\_shaping[​](#reward_shaping "标题的直接链接")
...
### sample\_process[​](#sample_process "标题的直接链接")
...
| 参数名 | 介绍 |
| :-: | --- |
| **list\_game\_data** | list(Frame)类型， 使用开发者自定义的Frame作为输入，因为样本一般进行批处理，所以传入列表 |
...
### SampleData2NumpyData[​](#sampledata2numpydata "标题的直接链接")
...
### NumpyData2SampleData[​](#numpydata2sampledata "标题的直接链接")
...
](/docs/p-competition-gorge_chase/15.0.1/guidebook/taa-rl-fw/rl_agent/info/)[

下一页

算法开发

](/docs/p-competition-gorge_chase/15.0.1/guidebook/taa-rl-fw/rl_agent/algorithm/)

*   [特征处理](#特征处理)
    *   [定义数据结构](#定义数据结构)
        *   [create\_cls](#create_cls)
    *   [观测处理](#观测处理)
        *   [observation\_process](#observation_process)
    *   [动作处理](#动作处理)
        *   [action\_process](#action_process)
*   [奖励设计](#奖励设计)
    *   [reward\_shaping](#reward_shaping)
*   [样本处理](#样本处理)
    *   [sample\_process](#sample_process)
    *   [SampleData2NumpyData](#sampledata2numpydata)
    *   [NumpyData2SampleData](#numpydata2sampledata)